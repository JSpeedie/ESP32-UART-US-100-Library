...
/* You can change this if you want, but it seems to me that of the 3 UART
 * ports on the ESP32, 0 and 1 are not entirely available(?) */
#define UART_PORT_NUM UART_NUM_2
/* Note how at the above link these are flagged as "U2RXD" and "U2TXD" matching
 * our decision to use UART port 2 */
